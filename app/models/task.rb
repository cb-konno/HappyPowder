...
class Task < ApplicationRecord
  ...
  validates :name, presence: true, length: { maximum: 50, message: I18n.t('errors.messages.too_long', count: 50) }
  validates :description, length: { maximum: 2000, message: I18n.t('errors.messages.too_long', count: 2000) }
